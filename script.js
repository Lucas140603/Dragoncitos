...
const alumnos = {
  "Josefina Alves": { xp: 13.5, mascota: "l" },
  "Yasmin Benitez": { xp: 10, mascota: "p" },
  "Julieta Cuadrado": { xp: 6.5, mascota: "d" },
  "Lucas Duarte": { xp: 3, mascota: "d" },
  "Mahia Echerán": { xp: 16.5, mascota: "pan" },
  "Facundo Gómez": { xp: 6, mascota: "leo" },
  "Uma Gonzalez": { xp: 9, mascota: "tuc" },
  "Valentino Gordano": { xp: 12, mascota: "vel" },
  "Juan Leles": { xp: 10, mascota: "s" },
  "Esteban Marins": { xp: 5, mascota: "d" },
  "Bautista Medina": { xp: 10.5, mascota: "tig" },
  "Aldana Montes": { xp: 10, mascota: "r" },
  "Mateo Nievas": { xp: 12, mascota: "g" },
  "Tadeo Noble": { xp: 14, mascota: "d" },
  "Gastón Olhagaray": { xp: 4, mascota: "d" },
  "Anastasia Olivera": { xp: 10, mascota: "v" },
  "Evelin Pereira": { xp: 7, mascota: "u" },
  "Isa Pintos": { xp: 6.5, mascota: "d" },
  "Joaquin Rodriguez": { xp: 10, mascota: "ag" },
  "Clara Romero": { xp: 12, mascota: "f" },
  "Luana Santestevan": { xp: 16.5, mascota: "chim" },
  "Julieta Santos": { xp: 16.5, mascota: "t" },
  "Guzman Silva": { xp: 0, mascota: "d" },
  "Axel Silva": { xp: 6, mascota: "d" },
  "Tiago Sosa": { xp: 6, mascota: "d" },
  "Julieta Torres": { xp: 4.5, mascota: "d" },
  "Fernando Trentini": { xp: 2, mascota: "d" },
  "Sofia Viera": { xp: 13, mascota: "a" }
};
