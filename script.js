...
const alumnos = {
  ...
  "Yasmin Benítez": { xp: 4, mascota: "p" },
  "Julieta Cuadrado": { xp: 4.5, mascota: "d" },
  "Lucas Duarte": { xp: 1.5, mascota: "d" },
  "Mahia Echerán": { xp: 9, mascota: "pan" },
  "Facundo Gómez": { xp: 2.5, mascota: "leo" },
  "Uma Gonzalez": { xp: 6, mascota: "tuc" },
  "Valentino Gordano": { xp: 4.5, mascota: "vel" },
  "Juan Leles": { xp: 3, mascota: "s" },
  "Esteban Marins": { xp: 1.5, mascota: "d" },
  "Bautista Medina": { xp: 3.5, mascota: "tig" },
  "Aldana Montes": { xp: 5, mascota: "r" },
  "Mateo Nievas": { xp: 4.5, mascota: "g" },
  "Tadeo Noble": { xp: 7, mascota: "d" },
  "Gastón Olhagaray": { xp: 1.5, mascota: "d" },
  "Anastasia Olivera": { xp: 6, mascota: "v" },
  "Evelin Pereira": { xp: 4, mascota: "u" },
  "Isa Pintos": { xp: 4.5, mascota: "d" },
  "Joaquin Rodriguez": { xp: 3, mascota: "ag" },
  "Clara Romero": { xp: 4.5, mascota: "f" },
  "Luana Santestevan": { xp: 9, mascota: "chim" },
  "Julieta Santos": { xp: 9, mascota: "t" },
