...
const alumnos = {
  "Josefina Alves": { xp: 15, mascota: "l" },
  "Yasmin Benitez": { xp: 13, mascota: "p" },
  "Julieta Cuadrado": { xp: 6.5, mascota: "d" },
  "Lucas Duarte": { xp: 3, mascota: "d" },
  "Mahia Echerán": { xp: 18.5, mascota: "pan" },
  "Facundo Gómez": { xp: 6, mascota: "leo" },
  "Uma Gonzalez": { xp: 9, mascota: "tuc" },
  "Valentino Gordano": { xp: 14.5, mascota: "vel" },
  "Juan Leles": { xp: 12.5, mascota: "s" },
  "Esteban Marins": { xp: 7, mascota: "d" },
  "Bautista Medina": { xp: 12.5, mascota: "tig" },
  "Aldana Montes": { xp: 11, mascota: "r" },
  "Mateo Nievas": { xp: 15, mascota: "g" },
  "Tadeo Noble": { xp: 17, mascota: "d" },
  "Gastón Olhagaray": { xp: 6, mascota: "d" },
  "Anastasia Olivera": { xp: 11, mascota: "v" },
  "Evelin Pereira": { xp: 8, mascota: "u" },
  "Isa Pintos": { xp: 7, mascota: "d" },
  "Joaquin Rodriguez": { xp: 12.5, mascota: "ag" },
  "Clara Romero": { xp: 14, mascota: "f" },
  "Luana Santestevan": { xp: 18.5, mascota: "chim" },
  "Julieta Santos": { xp: 18.5, mascota: "t" },
